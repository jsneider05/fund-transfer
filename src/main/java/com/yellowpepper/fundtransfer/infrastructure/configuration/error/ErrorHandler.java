package com.yellowpepper.fundtransfer.infrastructure.configuration.error;

import com.yellowpepper.fundtransfer.domain.exception.AccountFundException;
import com.yellowpepper.fundtransfer.domain.exception.ExternalApiException;
import com.yellowpepper.fundtransfer.domain.exception.InternalProcessException;
import com.yellowpepper.fundtransfer.domain.exception.InvalidValueException;
import com.yellowpepper.fundtransfer.domain.exception.NoDataException;
import com.yellowpepper.fundtransfer.domain.exception.RequiredValueException;
...
public class ErrorHandler extends ResponseEntityExceptionHandler {
  ...
  public ErrorHandler() {
    ...
    STATE_CODES.put(TransferLimitException.class.getSimpleName(), HttpStatus.PRECONDITION_FAILED.value());
    STATE_CODES.put(AccountFundException.class.getSimpleName(), HttpStatus.PRECONDITION_FAILED.value());
    STATE_CODES
  ...
  private Error handleConstraintValidationException(
